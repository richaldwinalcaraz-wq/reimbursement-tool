...
import { Archive, X, CheckCircle } from 'lucide-react';
...
export function ZipDropzone({ file, onFile, disabled }: Props) {
    ...
    >
      ...
      {file ? (
        ...
        <div>
          ...
          <p className="text-xs text-gray-400 mt-1">.zip only · Contains PDF reports</p>
        </div>
      )}
    </div>
  );
